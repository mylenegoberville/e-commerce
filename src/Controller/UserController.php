...
class UserController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/edit/profile", name="user_edit_profile", methods={"GET","POST"})
     */
    public function editprofile(Request $request, User $user): Response
    {
        if($this->getUser()){
           if ($user->getId() != $this->getUser()->getId()){
            return $this->redirectToRoute('user_edit_profile', ["id" => $this->getUser()->getId()], Response::HTTP_SEE_OTHER);
           }
        }
        else{
